...
- Xuất báo cáo: **CLI, HTML, JSON**
  ...
  <h3 class="text-lg font-bold text-indigo-700 mt-5 mb-3">Lệnh cốt lõi</h3>
...
```
  ...
  <div>
    <h3 class="text-lg font-bold text-blue-700 mb-3">Luồng tự động hóa</h3>
