...
- Các thành viên nhóm đã sử dụng các công cụ AI (Claude, Codex, Cursor,...) để hỗ trợ biên soạn tài liệu đánh giá công cụ AI và xây dựng cấu trúc workflow CI/CD.

| Thành viên                              | Công cụ AI                    | Thời gian truy cập          | Mục đích sử dụng                                                                                                                                                                                           | Minh chứng                                                                                                 |
| :-------------------------------------- | :---------------------------- | :-------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------- |
| **Mạch Quốc Tấn**<br>(23127115)         | Claude Sonnet 4.6 (Thinking)  | 2026-07-25 20:24:15 +07:00  | Hỗ trợ thiết lập tệp kịch bản tự động hóa (run-newman.sh và run-newman.ps1) thực thi Postman Collection bằng Newman CLI/Postman CLI và cấu hình báo cáo htmlextra/JSON.                                    | [AI Audit Report](https://drive.google.com/drive/folders/1cZTwtXoHKfrAcUMnOO8DO89e-o2Va6TY?usp=drive_link) |
| **Ngô Nguyễn Thế Khoa**<br>(23127065)   | Codex (GPT 5.6-sol)           | 2026-07-16 07:23:14 +07:00  | Hỗ trợ phân tích mã nguồn Pact Consumer/Provider, tra cứu tài liệu Pact bằng Context7 và cấu hình GitHub Actions CI/CD workflow cho Pact Verification.                                                     | [AI Audit Report](https://drive.google.com/drive/folders/1rgrEp0gmC7kiUlnDe6Pslr3H--dgjIwF?usp=drive_link) |
| **Nguyễn Lê Hồ Anh Khoa**<br>(23127211) | Claude Opus 4.8 (Claude Code) | 2026-07-18 16:00:00 +07:00  | Hỗ trợ tích hợp Newman vào GitHub Actions CI/CD pipeline, bổ sung route /health làm readiness probe và cấu hình lưu trữ test artifacts.                                                                     | [AI Audit Report](https://drive.google.com/drive/folders/1tcFhcu_VUzb9pvGOyPFa_u8z0qkdCR5F?usp=drive_link) |
| **Ân Tiến Nguyên An**<br>(23127148)     | Claude Sonnet 4.6 (Thinking)  | 2026-07-25 11:15:21 +07:00  | Hỗ trợ tích hợp job can-i-deploy của Pact CLI trong GitHub Actions workflow và biên soạn tài liệu hướng dẫn can-i-deploy quality gate.                                                                    | [AI Audit Report](https://drive.google.com/drive/folders/1kwi7ROYJkbCgIhK6sqfS5mpLspEZguAd?usp=drive_link) |
| **Nguyễn Tuấn Anh**<br>(23127152)       | Cursor (Grok 4.5 high fast)   | 2026-07-25 19:33:00 +07:00  | Hỗ trợ thử nghiệm sinh test case bằng Postman Postbot, biên soạn tài liệu đánh giá Postbot và xây dựng cẩm nang Prompt Guide cho API & Contract testing.                                                       | [AI Audit Report](https://drive.google.com/drive/folders/190_RqQz9wr1yj7ojzsLRXYmTmZ02p3Om?usp=drive_link) |
