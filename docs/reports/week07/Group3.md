...
Evidence: [Output documents](https://drive.google.com/drive/folders/YOUR_DRIVE_FOLDER_ID?usp=sharing)
...
| :-------------------------------------- | :---------------------------- | :-------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------- |
| **Mạch Quốc Tấn**<br>(23127115)         | Claude Sonnet 4.6 (Thinking)  | 2026-07-25 10:00:00 +07:00  | Hỗ trợ thiết lập shell script chạy Newman/Postman CLI và cấu hình báo cáo HTML/JSON tự động.                                                                                                                | [AI Audit Report](https://drive.google.com/drive/folders/YOUR_DRIVE_FOLDER_ID?usp=sharing) |
| **Ngô Nguyễn Thế Khoa**<br>(23127065)   | ChatGPT                       | 2026-07-24 15:30:00 +07:00  | Hỗ trợ cấu hình GitHub Actions CI/CD workflow cho bài kiểm tra Pact Verification cho Consumer và Provider.                                                                                                  | [AI Audit Report](https://drive.google.com/drive/folders/YOUR_DRIVE_FOLDER_ID?usp=sharing) |
| **Nguyễn Lê Hồ Anh Khoa**<br>(23127211) | Claude Opus 4.8               | 2026-07-24 11:20:00 +07:00  | Hỗ trợ tích hợp Newman vào GitHub Actions CI/CD pipeline và cấu hình lưu trữ test artifacts.                                                                                                               | [AI Audit Report](https://drive.google.com/drive/folders/YOUR_DRIVE_FOLDER_ID?usp=sharing) |
| **Ân Tiến Nguyên An**<br>(23127148)     | Claude Sonnet 4.6 (Thinking)  | 2026-07-25 14:15:00 +07:00  | Hỗ trợ tích hợp quality gate `can-i-deploy` của Pact CLI trong GitHub Actions.                                                                                                                              | [AI Audit Report](https://drive.google.com/drive/folders/YOUR_DRIVE_FOLDER_ID?usp=sharing) |
